...
public class StringUtil {
    ...
    public static String numberFormat(Double id, String patt) {
        NumberFormat formatter = new DecimalFormat(patt);
        return formatter.format(id);
    }
    ...
    public static String wrapQuote(String inputString) {
        return "'" + inputString + "'";
    }

    public static void main(String[] args) {
        System.out.println("Negative value of -1234.5463 : " + new StringUtil().getText(-1234.5463));
        System.out.println("Positive value of 1234.5463 : " + new StringUtil().getText(1234.5463));
        System.out.println("Negative string value of -1,234.5463 : " + new StringUtil().getText("-1,234.5463"));
        System.out.println("Positive string value of 1,234.5463 : " + new StringUtil().getText("1,234.5463"));
